...
def get_engine(provider, endpoint=None, original_model=""):
    ...
    (parsed_url.netloc == 'generativelanguage.googleapis.com' and "openai/chat/completions" not in parsed_url.path) or \
    (parsed_url.netloc == 'gateway.chatall.ru' and "v1beta" in parsed_url.path):
        engine = "gemini"
